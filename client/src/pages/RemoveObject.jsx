    ...
    {/* col left */}
        <form onSubmit={onsubmithandler} className='w-full lg:w-1/2 glass-panel p-6 sm:p-8 rounded-2xl border border-white/10'>
            ...
            <div className='flex items-center gap-3 mb-8'>
              ...
              <h1 className='text-2xl font-bold text-white tracking-wide'>Object Removal</h1>
            </div>
            ...
            <p className='mt-8 mb-3 text-sm font-medium text-text-light/80 uppercase tracking-wider'>Object to Remove</p>
          ...
          <textarea onChange={(e)=>setobject(e.target.value)} value={object} rows={4}
            ...
            border border-white/10 focus:border-primary/50 focus:ring-1 focus:ring-primary/50 transition-all resize-none placeholder-text-light/30' placeholder='e.g., watch or spoon (single object name)' required/>
        ...
        <div className='w-full lg:w-1/2 glass-panel p-6 sm:p-8 rounded-2xl flex flex-col border border-white/10 min-h-[500px]'>
          ...
          <div className='flex items-center gap-3 mb-6'>
            <div className="w-10 h-10 rounded-full bg-secondary/20 flex items-center justify-center border border-secondary/30">
              <Scissors className='w-5 text-secondary'/>
            </div>
          ...
          </div>
          {
            ...
            <div className='text-sm flex flex-col items-center gap-4 text-text-light/50 text-center px-4 relative z-10'>
              ...
              />
              <p className="mt-2 text-white/70">Upload an image and specify an object<br/> to see it removed</p>
